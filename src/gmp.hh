/*    C++ wrap for GMP
 ...
 Copyright Hans Aberg.
 
 Can be redistributed in possibly modified versions under the terms of the latest
 Free Software Foundation GNU General Public License <http://www.gnu.org/licenses/>
 valid at the time of redistribution, unless copyright distribution terms have been
 changed at that time by the copyright owner.
*/
